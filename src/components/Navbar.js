      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 min-w-0">
          ...
          <div className="flex items-center space-x-6 min-w-0">
            ...
            <Link to="/" className="flex items-center flex-shrink-0">
              ...
              <div className="ml-3 min-w-0">
                {/* Full name on lg */}
                <span className="hidden lg:block text-xl font-semibold text-gray-900 truncate max-w-[20rem]">Dr. Fatima Kasamnath</span>
                {/* Short on md */}
                <span className="hidden md:block lg:hidden text-lg font-semibold text-gray-900 truncate max-w-[12rem]">Dr. Fatima</span>
              </div>
            </Link>

            {/* Nav links (md+) - directly to the right of logo on the left side */}
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 ml-auto">
            ...
            {/* Auth controls (desktop only) - keep visible on md+ and styling unchanged */}
            {user ? (
              <button
                onClick={signOut}
