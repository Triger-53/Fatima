        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-semibold">Dr. Fatima Kasamnath</span>
              <span className="ml-2 text-sm text-gray-400">Speech Therapist</span>
            </div>
            <p className="text-gray-300 mb-4">
              Providing exceptional speech therapy services with compassion and expertise. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">Speech & Language Therapy</li>
              <li className="text-gray-300">Articulation Disorders</li>
              <li className="text-gray-300">Language Development</li>
              <li className="text-gray-300">Swallowing Disorders</li>
              <li className="text-gray-300">Voice Therapy</li>
              <li className="text-gray-300">Telepractice Available</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-300">info@drfatimakasamnath.com</span>
              </div>
              <div className="flex items-start">
