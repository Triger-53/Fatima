    ...
    <motion.div
      ...
      <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-xs text-blue-800 font-medium">
          Note: if you are booking for another patient, please create a new
          account for them.
        </p>
      </div>
        ...
        <>
          <div className="mt-4 flex items-center gap-4">
            <button
              ...
              className={`px-4 py-2 rounded-lg ${authMode === "signup"
      ...
      {authMessage && (
        <div
          className={`mt-3 p-3 rounded-lg text-sm ${authMessage.toLowerCase().includes("error") ||
